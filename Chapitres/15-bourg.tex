...
\hline
Population éparse (divers quartiers) & 81 & 76 & 279 & 278 & 1 \\
Population agglomérée au chef-lieu (bourg) & 71 & 86 & 230 & 228 & 2 \\
\hline
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Illustrations/illus-bourg-grande-rue.png}
\end{figure}
...
\par\hfill A. Collonge, curé d'Avenas.
\end{quote}

\begin{wrapfigure}{l}{0.40\textwidth}
    \vspace{-0.5\baselineskip}
    \includegraphics[width=0.37\textwidth]{Illustrations/illus-bourg-armoiries-guillin.png}
\end{wrapfigure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.82\textwidth]{Illustrations/illus-bourg-ouvrier-paysan.png}
\end{figure}

% --- Page imprimée 88 — vue 91
Aux siècles derniers la division de la propriété différait
peu à peu de celle qui existe à cette heure. Nous tenons à conserver le nom des divers propriétaires qui se partageaient la paroisse vers 1650. Nous indiquerons l'état de leurs revenus à cette époque.
...
Le Seigneur de la Barmondière : 2 domaines, également au Mas Dubost et la rente noble d'Arcis : 550 livres
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent}{8 livres}
\rente{Froment}{24 quarterons, 3 coupons et demi}
\rente{Seigle}{31       =       2       =      et demi}
\rente{Avoine}{202      =       9       =      et quart}
\rente{Poulet}{2 et un douzième d'autre}
\rente{Conil (lapin)}{un demi}
\end{tabbing}
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent}{31 sols 2 deniers viennois}
\rente{Seigle}{6 quarterons 8 coupons}
\rente{Orge}{2 raz}
\rente{Avoine}{14 raz 1 quarteron, 3 coupons et 3/4}
\rente{Geline (poule)}{une demie}
\end{tabbing}

Le Seigneur de Gorze : 3 domaines dont un au Thel et un autre près
du bourg, une maison dans le bourg, 1 moulin (anciennement moulin Châtelet) avec les rentes nobles de Nay, Nagu et Sacconay qu'il avait
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent}{8 livres, 13 sols, 4 deniers viennois}
\rente{Froment}{10 quarterons 6 coupons}
\rente{Seigle}{38 quarterons}
\rente{Avoine}{3 raz, 16 coupons}
\rente{Poule}{4 et une demie}
\end{tabbing}
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent}{5 livres 13 sols, 8 deniers}
\rente{Froment}{5 mesures, 9 coupons}
\rente{Seigle}{29 mesures 6 coupons deux tiers}
\rente{Avoine}{104 mesures}
\rente{Géline}{1 et trois quarts d'autre}
\end{tabbing}
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent}{5 livres 18 sols 2 deniers}
\rente{Froment}{1 quarteron 5 coupons}
\rente{Seigle}{16    =     7    =}
\rente{Avoine}{46  raz     4    =}
\rente{Géline}{2 et demi}
\end{tabbing}
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent viennois}{43 livres 3 sols}
\rente{Froment}{12 coupons et demi, mesure de Beaujeu}
\rente{Seigle}{4 quarterons, 5 coupons et demi}
\rente{Avoine}{10 quarterons, 4 coupons et demi}
\end{tabbing}
...
\begin{tabbing}
\hspace{0.38\textwidth}\=\kill
\rente{Argent}{7 livres, 3 deniers}
\rente{Froment}{2 tiers d'une coupe et 1 coupon}
\rente{Seigle}{10 coupons}
\rente{Avoine}{2 mesures 7 coupons}
\end{tabbing}
...
\begin{wrapfigure}{l}{0.40\textwidth}
    \vspace{-0.5\baselineskip}
    \includegraphics[width=0.37\textwidth]{Illustrations/illus-bourg-eglise-beaujeu.png}
\end{wrapfigure}
...
Il était recommandé aux collecteurs de s'imposer, eux et leurs parents, comme tous les autres et de ne pas user de représailles contre
% --- Page imprimée 91 — vue 94 (suite)
les collecteurs de l'année précédente ; leur cote ne devait être
augmentée qu'à proportion de l'augmentation des tailles.
    "Les ecclésiastiques étaient cotés pour les biens par eux acquis
purement et simplement ou reçus par succession collatérale ou donation. Ils ne l'étaient pas pour leurs biens d'église, leur titre presbytéral, ni pour les successions en ligne directe. Leurs fermiers ne
...
au greffe de l'élection avant le 1er Octobre.
    "Les receveurs et collecteurs ne pouvaient faire saisir les objets suivants : bestiaux arables, pain, lit, habits et ustensiles servant à la culture des prés, vignes, terres ; ni les cuves, tonneaux,
...
6 deniers pour tailles, subsistance, droits d'officier, quartier d'hiver, taillon et solde, ponts et chaussées, 12 deniers de l'armement naval, 6 deniers des directeurs de tailles, seconde partie de l'épargne, réparation du palais et prison royaux de Lyon. Ouroux était imposé
% --- Page imprimée 92 — vue 95 (suite)
pour la somme de 2334 livres payables en deux termes. En 1788, ses impositions pour le même objet étaient de 2813 livres.
...
\clearpage
\begin{center}
\ourouxsubtitle{Le loup dupé par le renard}
\end{center}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{Illustrations/illus-bourg-loup-renard.png}
\end{figure}
