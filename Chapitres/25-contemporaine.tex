...
\ourouxlettrine{\includegraphics[height=2.6\baselineskip]{Illustrations/lettrines/contemporaine.png}}{ans ce dernier chapitre de l'Histoire d'Ouroux, que nous avons intitulé « Période contemporaine », il nous reste à parler des quelques événements un peu plus saillants que les autres qui se sont passés au cours de ces 60 dernières années.}
