...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-salle-fetes.jpg}\end{center}

Dans ce dernier chapitre de l'Histoire d'Ouroux, que nous avons intitulé « Période contemporaine », il nous reste à parler des quelques événements un peu plus saillants que les autres qui se sont passés au cours de ces 60 dernières années.
...
Un bel exemple d'un maire chrétien : Mr Adrien BERLOTY
...
Guerre de 1914-1918  L'Abbé CLEMENT, soldat.
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-plaque-soldats.jpg}\end{center}
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-monument-morts.jpg}\end{center}
...
Catastrophes aériennes (1934 et 1937), par Marius LARGE
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-catastrophe-aerienne.jpg}\end{center}

% --- Page imprimée 268 — vue 271
Guerre de 1939-1945 — Bombardement d'Ouroux, par Cl. MELINAND
...
Démolition de vieilles maisons, par Ambroise BAUDRY
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-maisons-anciennes.jpg}\end{center}

% --- Page imprimée 271 — vue 274
Progrès social et matériel, par Jean BUFFIN de St-Mamert
