...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.52\textwidth]{Illustrations/illus-alloignet-ruines.png}
    \caption*{Ruines d'Alloignet}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption*{Plan du bourg de Saint-Antoine d'Ouroux d'après l'atlas cadastral parcellaire terminé le 28 octobre 1825.}
\end{figure}
