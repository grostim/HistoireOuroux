...
\begin{wrapfigure}{l}{0.42\textwidth}
    ...
    \includegraphics[width=0.39\textwidth]{Illustrations/illus-alloignet-ruines.png}
    \ourouxcaption{Ruines d'Alloignet}
\end{wrapfigure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.86\textwidth]{Illustrations/illus-alloignet-plan-bourg.png}
    \ourouxcaption{Plan du bourg de Saint-Antoine d'Ouroux d'après l'atlas cadastral parcellaire terminé le 28 octobre 1825.}
\end{figure}
