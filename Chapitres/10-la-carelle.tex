...
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Illustrations/illus-carelle-carrige.png}
\end{minipage}\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Illustrations/illus-carelle-roche.png}
\end{minipage}\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Illustrations/illus-carelle-magnin.png}
\end{minipage}
