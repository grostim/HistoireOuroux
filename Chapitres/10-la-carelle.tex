...
\begin{center}
    \includegraphics[width=0.16\textwidth]{Illustrations/illus-carelle-carrige.png}
\end{center}
De Carrige seigneur de la Carelle. De gueules, à 3 roses d'argent, 2 et 1.

\begin{center}
    \includegraphics[width=0.20\textwidth]{Illustrations/illus-carelle-roche.png}
\end{center}
De la Roche la Carelle. Seigneur de Poncié. de la Roche de la Carelle. Ecartelé au 1 et 4 d'argent à trois fasces de gueules, au 2 et 3 d'or au chevron d'azur, accompagné de 3 croisettes aussi d'azur, 2 et 1. Cimier : un soleil. Devise : qui s'y heurte s'y brise !

\begin{center}
    \includegraphics[width=0.20\textwidth]{Illustrations/illus-carelle-magnin.png}
\end{center}
Magnin de Pierreux Seigneur de Pierreux et de la Carelle. D'azur à 2 mains d'argent mouvantes des deux flancs de l'écu, arrachant chacune une tige de sinople ; issant d'une montagne d'or.
