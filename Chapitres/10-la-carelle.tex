...
% --- Composition fixe de la dernière page : les trois blasons sont
% --- solidaires de leur nom et de leur descriptif, comme dans l'original.
\noindent
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \scriptsize\textsc{De Carrige, seigneur de la Carelle.}

    \vspace{0.15\baselineskip}
    \includegraphics[width=0.82\linewidth]{Illustrations/illus-carelle-carrige.png}

    \vspace{0.15\baselineskip}
    \raggedright
    \scriptsize De gueules, à 3 roses d'argent, 2 et 1.
\end{minipage}\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \scriptsize\textsc{De la Roche, la Carelle.}

    \vspace{0.15\baselineskip}
    \includegraphics[width=0.96\linewidth]{Illustrations/illus-carelle-roche.png}

    \vspace{0.15\baselineskip}
    \raggedright
    \scriptsize Seigneur de Poncié. de la Roche de la Carelle. Ecartelé au 1 et 4 d'argent à trois fasces de gueules, au 2 et 3 d'or au chevron d'azur, accompagné de 3 croisettes aussi d'azur, 2 et 1. Cimier : un soleil. Devise : qui s'y heurte s'y brise !
\end{minipage}\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \scriptsize\textsc{Magnin de Pierreux, seigneur de Pierreux et de la Carelle.}

    \vspace{0.15\baselineskip}
    \includegraphics[width=0.96\linewidth]{Illustrations/illus-carelle-magnin.png}

    \vspace{0.15\baselineskip}
    \raggedright
    \scriptsize D'azur à 2 mains d'argent mouvantes des deux flancs de l'écu, arrachant chacune une tige de sinople ; issant d'une montagne d'or.
\end{minipage}
