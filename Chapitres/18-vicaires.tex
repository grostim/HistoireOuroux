...
XVI-\underline{Jean Marcellin Alvergnat} né à Rozier-Côte d'Aurec, canton de St-Bonnet le Château (Loire) fut installé vicaire à Ouroux le 16 Novembre 1852. Il est décédé curé à Lafont, paroisse fondée vers la fin du XIXe siècle, dans l'archiprêtré de St-Nisier d'Azergues. Il eut pour successeur :
...
\underline{N.B.}\quad\>Ici s'arrête la liste des vicaires dressée par l'Abbé Odouard.\\
...
XXIV-\underline{Mathieu Deschavanne} vicaire dans notre paroisse à partir du 24 Juin 1900 resta deux ans parmi nous. Il fut nommé ensuite vi
