...
\begin{figure}[htbp]
    ...
    \ourouxcaption{Maison bourgeoise d'Arcis, construite en 1881 et 1893}
\end{figure}
...
% Le panneau héraldique est conservé sous forme de recadrage direct du
% fac-similé : dessins, titre et annotations manuscrites restent solidaires.
\clearpage
\noindent
\begin{minipage}[t]{0.40\textwidth}
    \vspace{0pt}
    \includegraphics[width=\linewidth]{Illustrations/illus-arcis-armoiries-panneau.png}
\end{minipage}%
\hfill
