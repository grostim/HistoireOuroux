...
\begin{center}
    \includegraphics[width=0.16\textwidth]{Illustrations/illus-arcis-armoiries-nanton.png}
\end{center}
De Nanton
Seigneur de Pizey
De sinople
...
\begin{center}
    \includegraphics[width=0.16\textwidth]{Illustrations/illus-arcis-armoiries-pizeys.png}
\end{center}
De Piseys
D'argent
au chef bandé d'or et d'azur
de 6 pièces

\begin{center}
    \includegraphics[width=0.16\textwidth]{Illustrations/illus-arcis-armoiries-madelaine.png}
\end{center}
De La Madelaine-Ragny
Seigneur de Corcelles
Écartelé au 1 d'hermine
à 3 bandes de gueules,
chargées de 9 coquilles d'or.
2, 5 et 2 ;
au 2, d'or, à la croix
ancrée de gueules ;
au 3 de gueules, à
3 bandes d'argent ;
au 4 d'or et d'azur,
...
Devise :
Posita Feritate nitescit

\begin{center}
    \includegraphics[width=0.16\textwidth]{Illustrations/illus-arcis-armoiries-tircuy.png}
\end{center}
Tircuy de Corcelles
Seigneur de Corcelles, d'Arcis
de Flourye
D'azur, à la fasce d'or

\begin{center}
    \includegraphics[width=0.16\textwidth]{Illustrations/illus-arcis-armoiries-bottu.png}
\end{center}
