...
% Le texte peut ainsi remplir la page précédente avant que le panneau ne soit
% placé, sans laisser un demi-feuillet blanc derrière le dernier paragraphe.
\begin{wrapfigure}{l}{0.40\textwidth}
    \vspace{-0.5\baselineskip}
    \includegraphics[width=0.38\textwidth]{Illustrations/illus-arcis-armoiries-panneau.png}
\end{wrapfigure}
