...
\ourouxsubtitle{ÉCOLE DE FILLES}
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-ecole-maison-soeurs.jpg}\end{center}
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-ecole-filles-berloty.jpg}\end{center}
...
\begin{center}\includegraphics[width=0.62\textwidth]{Illustrations/illus-ecole-filles-1914.jpg}\end{center}
...
\begin{quote}
\textbf{Mesures disciplinaires — Arrêté de Mr le Préfet}
...
\textbf{Délibération du Conseil municipal d'Ouroux}
...
Malgré les sujets qu'ils avaient de craindre d'indisposer inutilement les maîtres de leurs enfants et de désobliger peut-être tel ou tel personnage, malgré leur profond respect pour des hommes spécialement
% --- Page imprimée 254 — vue 257 (suite)
voués aux intérêts religieux, la plupart des pères de famille ayant pétitionné près du Conseil Municipal ils doivent être bien convaincus eux-mêmes et il serait sans doute très curieux de voir combien la peur a retenu de signatures, de grands propriétaires forains se trouvant hostiles.
\end{quote}
