...
\begin{figure}[htbp]
    ...
    \caption*{Château actuel construit en 1851}
\end{figure}
...
\begin{center}
    \includegraphics[width=0.20\textwidth]{Illustrations/illus-grosbois-armoiries.png}
\end{center}
...
\begin{figure}[htbp]
    ...
    \caption*{Belle imposte en fer forgé surmontant la porte d'entrée au château de GrosBois.}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption*{Chapiteau roman historié dans une ferme du Thel.}
\end{figure}
